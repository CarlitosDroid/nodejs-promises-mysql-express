...
DROP TABLE EMPLOYEE;
DROP TABLE USER;
DROP TABLE MEETING_PLACE_DETAIL;
DROP TABLE MEETING_PLACE;
SET FOREIGN_KEY_CHECKS = 1;

DROP PROCEDURE IF EXISTS sp_GetUserByPin;
DROP PROCEDURE IF EXISTS sp_PostDetailSale;
DROP PROCEDURE IF EXISTS sp_PostHeaderSale;
**/
